            ...
            <div class="row">
                ...
                <div class="col-md-5 ms-auto">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <button class="btnpaypal btn-primary" type="button" id="btnPagar" onclick="window.location.href='formularioPago.php';">Pagar con  <img src="https://upload.wikimedia.org/wikipedia/commons/a/a4/Paypal_2014_logo.png" height ="50" width="50"></img></button>
                    </div>
                </div>
            </div>
        </div>
